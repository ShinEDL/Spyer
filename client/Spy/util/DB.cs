...
namespace Spy.util
{
    class DB
    {
        ...
        {
            string Severip = Spy.Login.Severip;
            MySqlConnection con ;
            //String mysqlstr = "database=spy;Data Source=172.18.13.42;User Id=shine;Password=abc123456;pooling=true;CharSet=utf8;port=3306";

            String mysqlstr = "database=spy;Data Source="+ Severip +";User Id=root;Password=123456;pooling=true;CharSet=utf8;port=3306";
        ...
        public int loginVilify(MySqlConnection mycon, string username)
        {
            ...
            try
            {
                ...
                String sql1 = "select cid from test.mac_cid where mac=" + '"' + mac + '"'; //创建查询语句
